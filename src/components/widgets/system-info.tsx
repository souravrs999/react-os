...
export default function SystemInformationWidget() {
  return (
    <div className="grid w-full h-full grid-cols-2 grid-rows-2 gap-4 rounded-2xl bg-primary dark:bg-background border border-border/20 p-4">
