...
const StudyTimerWidget: React.FC<StudyTimerProps> = ({
  ...
  return (
    <div className="relative flex w-full h-full flex-col gap-1 rounded-3xl bg-background p-4 text-white shadow-lg border border-border/20">
