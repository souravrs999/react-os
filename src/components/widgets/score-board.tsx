...
export default function ScoreBoard({
  ...
  return (
    <div className="group flex w-full h-full flex-col rounded-3xl border border-border/20 bg-background p-4 shadow-sm shadow-black/15 transition-all duration-700">
